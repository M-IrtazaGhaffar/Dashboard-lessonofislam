              ...
              return (
                <tr>
                  ...
                  <td className='actions'>
                    <svg onClick={()=> window.location.href = `https://www.lessonofislam.vercel.app/blogs/${1}`} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
                    ...
                    <svg onClick={() => n('/dashboard/edit', {
                     ...
                     xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
